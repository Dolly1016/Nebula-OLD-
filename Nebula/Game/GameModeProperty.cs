...
public class GameModeProperty
{
    ...
    public GameModeProperty(Module.CustomGameMode RelatedMode, IntRange ValidPlayers, bool RequireImpostors, bool CountTasks,  Roles.Role DefaultCrewmate, Roles.Role DefaultImpostor, Module.CustomOptionTab Tabs)
        : this(RelatedMode, ValidPlayers.min, RequireImpostors, CountTasks, DefaultCrewmate, DefaultImpostor, Tabs)
    {
        MaxPlayers = ValidPlayers.max;
    }

    public GameModeProperty(Module.CustomGameMode RelatedMode, int MinPlayers, bool RequireImpostors, bool CountTasks, Roles.Role DefaultCrewmate, Roles.Role DefaultImpostor, Module.CustomOptionTab Tabs)
    {
    ...
    {
        StandardMode = new GameModeProperty(Module.CustomGameMode.Standard, 4, true, true, Roles.Roles.Crewmate, Roles.Roles.Impostor,
        ...
        FreePlayMode = new GameModeProperty(Module.CustomGameMode.FreePlay, 0, false, false, Roles.Roles.Player, Roles.Roles.Impostor,
        ...
        StandardHnSMode = new GameModeProperty(Module.CustomGameMode.StandardHnS, 4, true, false, Roles.Roles.HnSCrewmate, Roles.Roles.HnSReaper,
        ...
        FreePlayHnSMode = new GameModeProperty(Module.CustomGameMode.FreePlayHnS, new IntRange(0, 1), false, false, Roles.Roles.HnSCrewmate, Roles.Roles.HnSReaper,
