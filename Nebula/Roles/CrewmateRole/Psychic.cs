...
namespace Nebula.Roles.CrewmateRoles
{
    public class Psychic : Role
    {
        ...
        private string[] PsychicMessage = new string[] { "elapsedTime", "killerColor", "killerRole", "losing" };
        ...
        public override void MyPlayerControlUpdate()
        {
            ...
            foreach (Game.DeadPlayerData deadPlayerData in Game.GameData.data.deadPlayers.Values)
            {
                ...
                string m_time = "", m_color = "", m_role = "";
                List<string> messageSet = new List<string>();
                
                messageSet.Add("elapsedTime");
                ...
                if (deadPlayerData.MurderId != Byte.MaxValue)
                {
                    ...
                    messageSet.Add("killerColor");
                    messageSet.Add("killerRole");
                }
                ...
                transratedMessage = transratedMessage.Replace("%TIME%",m_time).Replace("%COLOR%",m_color).Replace("%ROLE%",m_role);
