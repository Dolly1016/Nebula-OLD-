...
public class NebulaPlugin : BasePlugin
{
    ...
    public static string PluginVisualVersion = IsSnapshot ? "22.12.19c" : PluginVersion;
    public static string PluginStage = IsSnapshot ? "Snapshot" : "";
    
    public const string PluginVersionForFetch = "2.0.2";
    public byte[] PluginVersionData = new byte[] { 2, 0, 2, 0 };
