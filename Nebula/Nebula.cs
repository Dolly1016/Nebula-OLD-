...
public class NebulaPlugin : BasePlugin
{
    ...
    public const string PluginVersion = "2.0.2.1";
    public const bool IsSnapshot = true;

    public static string PluginVisualVersion = IsSnapshot ? "22.12.21a" : PluginVersion;
    public static string PluginStage = IsSnapshot ? "Snapshot" : "";
    
    public const string PluginVersionForFetch = "2.0.2.1";
    public byte[] PluginVersionData = new byte[] { 2, 0, 2, 1 };
