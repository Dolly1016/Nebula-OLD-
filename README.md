...
| 日本語 | kihi | 1.12.7.2 | [Download](https://github.com/Dolly1016/Nebula/releases/download/LANG%2CJP%2C1.12.7.2%2Ckihi/Japanese.dat)|
 ...
 **Version 1.12.10**
 - 排他的役職割り当てにいくつかの設定を追加しました。
 - Morphingの効果時間を最大40秒まで設定できるようにしました。
 ...
 **Version 1.12.9**
 ...
 - Sheriffの弾数を制限できるようになりました。
 - Doctorのモバイル端末の利用可能時間を常時確認できるようにしました。
